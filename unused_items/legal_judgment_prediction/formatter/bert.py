    ...
    def process(self, data, *args, **kwargs):
        if self.mode == 'generate' or self.mode == 'serve':
            ...
            for one_data in data:
                ...
                fact_vectors.append(self.tokenizer.convert_tokens_to_ids(fact))
                ...
                accusation_vector = np.zeros(len(self.accusation2id)
                    , dtype=np.int)
