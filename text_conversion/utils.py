...
def text_conversion(parameters):
    logger.info(f'Start to convert text with {parameters["config"]} config.')
    ...
    logger.info(
        f'Convert text with {parameters["config"]} config successfully.')